<?php
class Ewall_Wholesale_Model_Product_Type_Price {
    ...
    public function getPrice($product) {
        //Calling event for updating price in product detail page
        Mage::dispatchEvent('catalog_product_get_finals_price', array('product' => $product, 'qty' => @$qty));
